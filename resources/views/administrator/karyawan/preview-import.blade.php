...
@section('title', 'Preview Import Karyawan - PT. Arthaasia Finance')
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="department{{ $item->id }}">
                                                     <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            <td>Unit</td>
                                                            <td>{{ isset($item->section->name) ? $item->section->name : ''  }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Position</td>
                                                        ...
                                                        <tr>
                                                            <td>HO / Branch</td>
                                                            <td>{{ $item->organisasi_ho_or_branch }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Status</td>
